...
## MALES OR FEMALES
dat <- read.csv('/users/dgibbs/proj/gbm_sex/data/jive_training_array_data_M.csv')
...
save(resdf, file=paste0('/users/dgibbs/proj/gbm_sex/results/male_resdf_',this_label,'.rda'))

write.csv(resdf, file=paste0('/users/dgibbs/proj/gbm_sex/results/feature_pairs_males_',this_label,'.csv'), quote=F)
