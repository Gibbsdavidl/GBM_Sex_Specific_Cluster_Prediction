...
## MALES OR FEMALES
dat <- read.csv('../data/Males_CV_Data_v3.csv')
...
colnames(resdf) <- c('cluster','pair','gene_i','gene_j','prop_this_cluster','prop_not_cluster','dist_ij_cluster','dist_ij_not_cluster','prop_diff')
save(resdf, file=paste0('male_resdf_',this_label,'_thresh04.rda'))
write.csv(resdf, file=paste0('feature_pairs_males_',this_label,'_thresh04.csv'))
