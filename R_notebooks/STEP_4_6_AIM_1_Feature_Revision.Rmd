...
gpairs <- shorter_and_clean(genepairs_val, 24)
...
ggsurvplot(modfit, pval = T, xlab="Months",pval.coord = c(1, 0),)
#modfit <- survfit(Surv(Survival, CensoredCode)~BestCalls,data=resdf)
#ggsurvplot(modfit, pval = T, xlim=c(0,1700))
ggsave('../figures/males_validation_survival_curve_refined_features_v2.pdf',width = 8,height = 8)
