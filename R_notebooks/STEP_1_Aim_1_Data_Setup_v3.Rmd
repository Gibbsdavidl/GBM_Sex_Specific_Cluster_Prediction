...
write.table(tcga_dwnld, file = '../../rawdata/tempus_dwnld.csv', quote = F, row.names = F, sep = ',')

tcga_dwnld <- read_csv('../data/bq-results-20240316__TCGA_RNA_seq.csv')
...
write.csv(tempus_male2,"../data/Tempus_Males.csv",row.names=F)

#tempus.f.test$cluster.group <- NA
write.csv(tempus_female2,"../data/Tempus_Females.csv",row.names=F)
```
