...
write.csv(rna_f,'../data/cptac3_gbm_rnaseq_table_unstranded_Female.csv',quote = F,row.names = F)
write.csv(rna_m,'../data/cptac3_gbm_rnaseq_table_unstranded_Male.csv',quote = F,row.names = F)
