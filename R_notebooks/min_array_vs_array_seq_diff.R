...
mc2 <- read_csv('../../archive/Classifier_Workflow/STEP_2_AIM_1_Feature_Selection/results/feature_pairs_males_cluster2.csv.gz')
mc5 <- read_csv('../../archive/Classifier_Workflow/STEP_2_AIM_1_Feature_Selection/results/feature_pairs_males_cluster5.csv.gz')
fc5 <- read_csv('../../archive/Classifier_Workflow/STEP_2_AIM_1_Feature_Selection/results/feature_pairs_female_cluster5.csv.gz')
fc4 <- read_csv('../../archive/Classifier_Workflow/STEP_2_AIM_1_Feature_Selection/results/feature_pairs_female_cluster4.csv.gz')
fc1 <- read_csv('../../archive/Classifier_Workflow/STEP_2_AIM_1_Feature_Selection/results/feature_pairs_female_cluster1.csv.gz')


load('../../version3/Feature_Selection_Male.Rmd')
