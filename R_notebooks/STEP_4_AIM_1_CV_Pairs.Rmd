...
write_csv(metrics, file='../results/females_tcga_array_metrics_step4_v2.csv')
metrics
```
...
save(imp_list, file='../results/female_CV_pairs_importance_step4_v2.rda')
...
load('../results/female_CV_pairs_importance_step4_v2.rda')

allimp <- rbind(df1,df2,df3,df4,df5)

write.csv(allimp, file='../results/female_importance_table_v2.csv')
